...
for lol in no_site_name_list:
    ...
    filer = open(sys.argv[3] + 'tf_h2_' + lol + '/meme.txt')
    ...
    with open(sys.argv[3] + 'tf_h2_' + lol + '/tf_h2_' + lol +  '.memeSites', 'w') as tf_out_fasta:
...
with open(sys.argv[4]) as db_tftgtfbs_file, open(sys.argv[4].split('.')[0] + '.sites2.out', 'a') as out_file2:
    for line in csv.reader(db_tftgtfbs_file, delimiter = '\t'):
        line.append([])
        print('Target:\t' + str(line))
        print('Opening:\t' + sys.argv[3] + 'tf_h2_' + line[0] + '/tf_h2_' + line[0] + '.memeSites')
        try:
            with open(sys.argv[3] + 'tf_h2_' + line[0] + '/tf_h2_' + line[0] + '.memeSites') as sites_file:
                for site_id, site_seq in readFastaGenerator(sites_file):
                    print('\t\t' + site_id)
                    print('\t\t' + site_seq)
                    # time.sleep(.1)
